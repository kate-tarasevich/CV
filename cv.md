...
2.BACHELOR'S DEGREE (2017-2020) Belarusian State Academy of communication
...
2.SOFTWARE ENGINEER INTERN SevenSenders Berlin, Germany (apr- jul 2022)
    ...
    included handling small-scale tasks, working with
    databases using SQL, and developing the
    client-side of web applications using JavaScript,
    HTML, and CSS. Additionally, I participated in code
    reviews, functionality testing, and working with
    Git for version control. This internship provided
    me with an opportunity to enhance my Fullstack
    development skills and develop effective
    teamwork abilities.
...
### Projects examples
********* 
* [Promo-to-intensive (HTML, CSS)](https://kate-tarasevich.github.io/Promo-to-intensive/)
* [Bakery (HTML, CSS)](https://kate-tarasevich.github.io/Bakery/)
* [Guitar-lessons (HTML, CSS, Sass, JS, SCSS)](https://kate-tarasevich.github.io/Guitar-lessons/)
* [coffee-house (HTML, CSS, Sass, JS, SCSS)](https://kate-tarasevich.github.io/coffee-house/index.html)